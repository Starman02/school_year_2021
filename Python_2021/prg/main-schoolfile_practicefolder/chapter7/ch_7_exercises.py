...
months_of_the_year = []
for items in months:
    months_of_the_year.append(items)
...
supermonths = [['January', 31], ['February', 29], ['March', 31], ['April', 30], ['May', 31], ['June', 30], ['July', 31], ['August', 31], ['September', 30], ['October', 31], ['November', 30], ['December', 31]]
# 2) Print the contents of the entire list
print(supermonths)
# 3) Print just the values for index 3,0 and 3,1
print("\n", supermonths[3][0], supermonths[3][1])
# TODO 7.9 Tuples
