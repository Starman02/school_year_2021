...
def battle_start(C_INDEX, E_INDEX):
    ...
    Attack = Button(BLUE, 280, 100, 'attack', 'assets/buttons/attack.png')
    Items = Button(RED, 280, 100, 'items', 'assets/buttons/heal.png')
    Flee = Button(GREEN, 280, 100,  'flee', 'assets/buttons/flee.png')
