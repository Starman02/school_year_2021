"""
A kind semi important but probably not message: 
wassup man, so i tried to start a bit of the program, I found a great youtube series on how to make an entire rpg game from scrath, pretty handy for a starting resource. 
For most of the start for this program I followed this tutorial: https://www.youtube.com/watch?v=crUF36OkGDw&list=PLkkm3wcQHjT7gn81Wn-e78cAyhwBW3FIc
"""


import pygame
from BATTLE_GUI_TESTING_SCENE import *
from sprites_test2 import *
...
class MainGame:         # started by devin
    def __init__(self):  # class started by devin
        ...
        self.character_spritesheet = SpriteSheet(
            'img/Wario_sprite_purple_fina.png')
